...
var closableTab = {
    ...
    addTab:function(tabItem){ //tabItem = {id,name,url,closable}
        ...
        if(!$('#'+id)[0]){
            var li_tab = '<li role="presentation" class="" id="'+id+'"><a href="#'+container+'" onclick="closableTab.activeTab(this)"  role="tab" data-toggle="tab" style="position: relative;padding:2px 20px 2px 15px">'+tabItem.name;
            if(tabItem.closable){
